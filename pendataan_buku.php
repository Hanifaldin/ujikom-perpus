                ...
                <form action="" method="POST">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if($query){
                            ...
                            echo '<script>alert("Tambah data gagal, Coba lagi"); location.href="?page=pendataan_buku"</script>';
                        }
                    }
                    ?>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-8"><input type="number" required name="tahun_terbit" class="form-control"></div>
                    </div>
                    <div class="row form-group">
