                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" type="text" required name="no_telepon" placeholder="Masukan Nomor Telepon" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="smal mb-1">Username</label>
                                            ...
                                            <div class="form-group">
                                                <label class="smal mb-1">Level</label>
                                                <select name="level" class="form-control py-4">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button class="btn btn-danger" type="submit" name="register" value="register">Register</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small">
                                            &copy; 2024 Perpustakaan Digital Aretha
                                        </div>
                                    </div>
                                </div>
                            </div>
